...
Let us write $N(t)$ for the number of customers that enters during the time interval $[0,t]$ and $N(s, t] = N(t)-N(s)$ for the number that arrives in the time period $(s, t]$.
